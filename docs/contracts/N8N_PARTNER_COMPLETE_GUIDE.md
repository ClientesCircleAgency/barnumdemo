# Guia Completo para o Parceiro n8n — Barnun
...
O Barnun é uma plataforma de gestão de clínicas. O n8n é responsável por enviar mensagens WhatsApp aos pacientes quando certos eventos acontecem na base de dados.
...
|----------|-----------|----------|
| `DB_WEBHOOK_SECRET` | Combinar com o admin do Barnun | Validar que os webhooks vêm do Supabase |
...
### Antes de começar
- [ ] Receber `DB_WEBHOOK_SECRET` do admin Barnun
...
- Contactar o admin do Barnun para credenciais e acesso
