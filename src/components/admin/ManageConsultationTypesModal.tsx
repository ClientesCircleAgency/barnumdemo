...
export function ManageConsultationTypesModal({
  ...
  const { consultationTypes, specialties, appointments, addConsultationType, updateConsultationType, removeConsultationType } = useClinic();
  ...
  const handleDelete = (id: string) => {
    ...
    if (inUse) {
      toast.error('Não é possível remover um tipo de consulta com consultas activas.');
