...
ALTER TABLE "public"."desistências" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."desistências"
    ADD CONSTRAINT "desistências_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_appointments_finalized_at" ON "public"."appointments" USING "btree" ("finalized_at") WHERE ("finalized_at" IS NOT NULL);
...
CREATE INDEX "idx_desistências_appointment_request_id" ON "public"."desistências" USING "btree" ("appointment_request_id");



CREATE INDEX "idx_desistências_patient_id" ON "public"."desistências" USING "btree" ("patient_id");
...
ALTER TABLE ONLY "public"."desistências"
    ADD CONSTRAINT "desistências_appointment_id_fkey" FOREIGN KEY ("appointment_id") REFERENCES "public"."appointments"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."desistências"
    ADD CONSTRAINT "desistências_appointment_request_id_fkey" FOREIGN KEY ("appointment_request_id") REFERENCES "public"."appointment_requests"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."desistências"
    ADD CONSTRAINT "desistências_patient_id_fkey" FOREIGN KEY ("patient_id") REFERENCES "public"."patients"("id") ON DELETE SET NULL;
...
GRANT ALL ON TABLE "public"."desistências" TO "anon";
GRANT ALL ON TABLE "public"."desistências" TO "authenticated";
GRANT ALL ON TABLE "public"."desistências" TO "service_role";
